...
rm -f ~/.tmux.conf
rm -f ~/dotfiles/vscode/user/settings.json ~/.config/Code/User/settings.json
rm -rf ~/dotfiles/vscode/user/snippets ~/.config/Code/User/snippets
rm -f ~/dotfiles/vscode/user/keybindings.json ~/.config/Code/User/keybindings.json

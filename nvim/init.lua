...
vim.cmd([[highlight link EasyMotionTarget Statement]])
vim.cmd([[highlight link EasyMotionShade Comment]])
...
vim.keymap.set('n', '<C-d>', ':split|execute\'resize 15\'|terminal<cr>', { silent = true })

...
syn keyword cobolStatement contained accept add all assign and call cancel close compute commit continue copy delete display divide else end-if end-evaluate end-perform 
